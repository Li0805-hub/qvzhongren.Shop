...
namespace qvzhongren.Shop.Host;
...
public class ShopHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        services.AddAutoMapper(typeof(ShopHostModule));
        ...
        {
            options.ConventionalControllers.Create(typeof(ShopHostModule).Assembly);
        });
