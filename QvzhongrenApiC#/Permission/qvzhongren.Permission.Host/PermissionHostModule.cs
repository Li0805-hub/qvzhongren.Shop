...
namespace qvzhongren.Permission.Host;
...
public class PermissionHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        services.AddAutoMapper(typeof(PermissionHostModule));
        ...
        {
            options.ConventionalControllers.Create(typeof(PermissionHostModule).Assembly);
        });
        ...
        services.AddSwaggerGen(options =>
        {
            options.SwaggerDoc("v1", new OpenApiInfo
            {
                ...
                Version = "v1",
                Description = "Permission 微服务接口文档"
            });
